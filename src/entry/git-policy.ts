 ...
 * the human owns git. Folder dispatch and the legacy modes are managed: one
 * branch up front and one commit per completed issue.
 */
...
/** Resolve the git policy for a dispatch mode. Only `direct` is fully local. */
